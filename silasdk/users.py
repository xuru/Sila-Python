...
class User:
    ...
    def getTransactions(app, payload: dict, user_private_key: str) -> dict:
        ...
        """
        warnings.warn(
            "This method has been deprecated in favor of get_transactions",
            DeprecationWarning,
        )
    ...
    def silaBalance(self, address):
        ...
        if self.app.tier == "prod":
            endpoint = endPoints["silaBalanceProd"]
        elif self.app.tier == "sandbox":
    ...
    def addRegistrationData(
        ...
        """
        warnings.warn(
            "This method has been deprecated in favor of add_registration_data",
            DeprecationWarning,
        )
        return User.add_registration_data(
            app, registration_field, payload, user_private_key
        )
    ...
    def updateRegistrationData(
        ...
        """
        warnings.warn(
            "This method has been deprecated in favor of update_registration_data",
            DeprecationWarning,
        )
        return User.update_registration_data(
            app, registration_field, payload, user_private_key
        )
